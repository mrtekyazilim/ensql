...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <nav className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-800 dark:to-green-900/20 shadow-sm border-b border-green-100 dark:border-gray-700">
                      ...
                      <div className="py-1">
                        ...
                        <button
                          onClick={() => {
                            ...
                            localStorage.removeItem('partner-deviceId')
